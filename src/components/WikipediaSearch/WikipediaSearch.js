...
class WikipediaSearch extends Component {
    ...
    render() {
        return (
            <div>
                <p>Aquí hay un enlace a la página de Rodriguez Angobaldos{this.state.nombreCurado}: </p>
                <a href={"https://er.com.pe/" + this.state.busqueda} target="_blank">{this.state.nombreCurado}</a>
            </div>
        )
    }
